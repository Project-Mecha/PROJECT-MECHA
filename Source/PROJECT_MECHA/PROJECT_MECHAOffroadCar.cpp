...
#include "PROJECT_MECHAOffroadCar.h"
#include "PROJECT_MECHAOffroadWheelFront.h"
#include "PROJECT_MECHAOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

APROJECT_MECHAOffroadCar::APROJECT_MECHAOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPROJECT_MECHAOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPROJECT_MECHAOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPROJECT_MECHAOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPROJECT_MECHAOffroadWheelRear::StaticClass();
