...
#include "PROJECT_MECHASportsCar.h"
#include "PROJECT_MECHASportsWheelFront.h"
#include "PROJECT_MECHASportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

APROJECT_MECHASportsCar::APROJECT_MECHASportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPROJECT_MECHASportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPROJECT_MECHASportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPROJECT_MECHASportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPROJECT_MECHASportsWheelRear::StaticClass();
